...
import { StaggeredCleanup, globalStaggeredCleanup, staggeredCompactArray, immediateCompactArray } from "../../../src/js/core/staggered-cleanup.js";
...
describe("StaggeredCleanup", () => {
    ...
    describe("schedule", () => {
        ...
        it("should give higher priority to arrays with more dead items", () => {
            ...
            const largeArray = [{ dead: true }, { dead: true }, { dead: true }, { dead: true }, { dead: true }];
    ...
    describe("process", () => {
        ...
        it("should remove dead items from arrays", () => {
            const array = [{ dead: true }, { dead: false }, { dead: true }, { dead: false }, { dead: true }];
        ...
        it("should call cleanup function for dead items", () => {
            ...
            const array = [{ dead: true, id: 1 }, { dead: false, id: 2 }];
...
describe("staggeredCompactArray", () => {
    ...
    it("should call cleanup function", () => {
        const cleanupFn = vi.fn();
        const array = [{ dead: true, id: 1 }, { dead: false, id: 2 }, { dead: true, id: 3 }, { dead: false, id: 4 }, { dead: true, id: 5 }];
