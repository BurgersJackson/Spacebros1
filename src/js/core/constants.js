  ...
  categories: [
    {
      ...
      upgrades: [
        ...
        },
        {
          id: "shotgun",
          name: "Flak Shotgun",
          tier1: "Unlock: 5 Pellets",
          tier2: "8 Pellets, +Range",
          tier3: "12 Pellets",
          tier4: "16 Pellets, +Range",
          tier5: "20 Pellets, max range",
          notes: "Close-range burst."
        },
        {
          id: "static_weapons",
          name: "Static Weapons",
        ...
        },
        {
          id: "volley_shot",
          name: "Volley Shot",
          tier1: "Auto-fires 3-shot burst every 2s",
          tier2: "4-shot burst every 2s",
          tier3: "5-shot burst every 2s",
          tier4: "6-shot burst every 2s",
          tier5: "7-shot burst every 2s",
          notes: "Automatic burst damage. No input required."
        },
        {
          id: "ciws",
          name: "CIWS",
        ...
        },
        {
          ...
          tier1: "Projectiles chain to 1 enemy (200u)",
          tier2: "Chain to 2 enemies (250u)",
          tier3: "Chain to 3 enemies (300u)",
      ...
      upgrades: [
        {
          ...
          tier2: "+25 Max HP, Heal 25",
          tier3: "+25 Max HP, Heal 25",
          tier4: "+25 Max HP, Heal 25",
          tier5: "+25 Max HP, Heal 25",
          notes: "Increases survival."
        },
        {
          id: "segment_count",
          name: "Segment Count",
          tier1: "+2 segments (total 10)",
          tier2: "+4 total (14)",
          tier3: "+8 total (18)",
          tier4: "+12 total (26)",
          tier5: "+16 total (30)",
          notes: "Larger shield bubble."
        },
        {
          id: "outer_shield",
          name: "Outer Shield",
          tier1: "6 purple segments",
          tier2: "8 segments (restore all)",
          tier3: "12 segments (restore all)",
          tier4: "16 segments (restore all)",
          tier5: "20 segments (restore all)",
          notes: "Extra rotating ring (1 HP/seg)."
        },
        {
          id: "shield_regen",
          name: "Shield Regen",
          tier1: "Regen 1 seg./5s",
          tier2: "1 seg./3s",
          tier3: "1 seg./1s",
          tier4: "1 seg./0.75s",
          tier5: "1 seg./0.5s",
          notes: "Sustain in long fights."
        },
        {
          id: "hp_regen",
          name: "Hull Regen",
          ...
          tier4: "Regen 4 HP / 5s",
          tier5: "Regen 5 HP / 5s",
          notes: "Slow passive healing."
        },
        {
          id: "reactive_shield",
          name: "Reactive Shield",
          tier1: "Shield segments restore on kill",
          tier2: "Restore 2 segments per kill",
          tier3: "Restore 3 segments, +25% shield HP",
          tier4: "Restore 4 segments, +50% shield HP",
          tier5: "Restore 5 segments, +75% shield HP",
          notes: "Offensive play heals shields. Aggressive sustain."
        },
        {
          id: "damage_mitigation",
          name: "Damage Mitigation",
          tier1: "-10% damage taken, +5% move speed",
          tier2: "-20% damage taken, +10% move speed",
          tier3: "-30% damage taken, +15% move speed",
          tier4: "-40% damage taken, +20% move speed",
          tier5: "-50% damage taken, +25% move speed",
          notes: "Tanky AND fast. General survivability."
        }
      ]
    },
    {
      ...
      upgrades: [
        ...
        },
        {
          id: "turbo_boost",
          name: "Turbo Boost",
          tier1: "+50% speed for 2s",
          tier2: "+50% speed for 3.5s",
          tier3: "+50% speed for 5s",
          tier4: "+50% speed for 6.5s",
          tier5: "+50% speed for 8s",
          notes: "Press E / Gamepad X."
        }
      ]
    },
    {
      ...
      upgrades: [
        ...
        },
        {
          id: "invincibility",
          name: "Phase Shield",
          tier1: "3s Active / 20s CD",
          tier2: "5s Active / 15s CD",
          tier3: "7s Active / 10s CD + Regen",
          tier4: "9s Active / 8s CD + Regen",
          tier5: "12s Active / 6s CD + Regen",
          notes: "Auto-cycling invulnerability."
        },
        {
          id: "slow_field",
          name: "Stasis Field",
          tier1: "Stops roamers 3s",
          tier2: "Stops 5s, +25% Area",
          tier3: "Stops 8s, +25% Area",
    ...
    },
    {
      ...
      upgrades: [
        {
          id: "companion_drones",
          name: "Companion Drones",
          tier1: "Unlock Shooter Drone",
          tier2: "Add Shield Drone",
          tier3: "Add Heal Drone",
          tier4: "Add 2nd Shooter Drone",
          tier5: "Add 2nd Shield Drone",
          notes: "Orbiting support bots."
        }
      ]
    }
  ]
