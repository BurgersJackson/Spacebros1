...
export class SpriteEditor {
  ...
  _createLeftToolbar() {
    ...
    optionsSection.innerHTML =
      '<h3 style="margin:0 0 10px 0;font-size:14px;color:#888;">OPTIONS</h3>';

    const gridToggle = this._createCheckbox("Show Grid (G)", this.showGrid, v =>
      this.toggleGrid(v)
    );
  ...
  _setupCanvasEvents() {
    ...
    const getPixelPos = e => {
      ...
      const x = Math.floor(
        ((e.clientX - rect.left) * scaleX) / (this.canvasSize / this.resolution)
      );
    ...
    canvas.addEventListener("mousemove", e => {
      ...
      if (this.currentTool === TOOLS.BRUSH || this.currentTool === TOOLS.ERASER) {
        this._drawLine(
          ...
          pos.x,
          pos.y,
          this.currentTool === TOOLS.ERASER ? null : color
        );
        this.lastX = pos.x;
        this.lastY = pos.y;
        this._renderCanvas();
  ...
  _createRightPanel() {
    ...
    previewSection.innerHTML =
      '<h3 style="margin:0 0 10px 0;font-size:14px;color:#888;">PREVIEW (In-Game Scale)</h3>';
    ...
    radiusControl.innerHTML =
      '<label style="font-size:12px;color:#aaa;">Collision Radius: <span id="radius-value">64</span></label>';
    ...
    const secondaryColorBox = this._createColorBox(
      this.secondaryColor,
    ...
    exportSection.innerHTML =
      '<h3 style="margin:0 0 10px 0;font-size:14px;color:#888;">EXPORT</h3>';
    ...
    codeSection.innerHTML =
      '<h3 style="margin:0 0 10px 0;font-size:14px;color:#888;">GENERATED CODE</h3>';
