...
export function showLevelUpMenu() {
    ...
    UPGRADE_DATA.categories.forEach(cat => {
        cat.upgrades.forEach(up => {
            const currentTier = (GameContext.player && GameContext.player.inventory && GameContext.player.inventory[up.id]) || 0;
    ...
    choices.forEach((choice) => {
        const currentTier = (GameContext.player && GameContext.player.inventory && GameContext.player.inventory[choice.id]) || 0;
        const nextTier = currentTier + 1;
