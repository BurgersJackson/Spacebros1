...
export class CavePinwheel1 extends Pinwheel {
    constructor(x, y) {
        // Call parent constructor with 'standard' type to inherit all base functionality
        super(x, y, 'standard');
        // Override type to identify as cave variant
        this.type = 'cave1';
        // All initialization is handled by Pinwheel constructor
        // We just need to override type for identification
    }
