        ...
        if (this.phaseName === 'GRAVITY_WELL') {
            ...
            if (this.phaseTick % 30 === 0) {
                ...
                for (let i = 0; i < 14; i++) {
                    ...
                    const b = new Bullet(this.pos.x, this.pos.y, a, 9, { owner: 'enemy', damage: 1, radius: 4, color: '#0af' });
                    b.owner = this;
            ...
            if (this.phaseTick % 25 === 0) {
                // Spread shots
                for (let i = -2; i <= 2; i++) {
                    const b = new Bullet(this.pos.x, this.pos.y, aim + i * 0.2, 11, { owner: 'enemy', damage: 1, radius: 4, color: '#0af' });
                    b.owner = this;
                    GameContext.bullets.push(b);
                }
                playSound('shoot');
            ...
            if (this.phaseTick % 40 === 0) {
                ...
                for (let i = 0; i < 20; i++) {
                    ...
                    const b = new Bullet(this.pos.x, this.pos.y, a, 10, { owner: 'enemy', damage: 1, radius: 4, color: '#0cf' });
                    b.owner = this;
                    GameContext.bullets.push(b);
                }
                playSound('shotgun');
