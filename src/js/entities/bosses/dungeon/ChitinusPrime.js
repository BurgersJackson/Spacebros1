...
export class ChitinusPrime extends Enemy {
    ...
    runPhaseAttacks() {
        ...
        if (this.phaseName === 'ARMED_ASSAULT') {
            if (this.phaseTick % 12 === 0) {
                // Triple fire
                for (let i = -1; i <= 1; i++) {
                    const b = new Bullet(this.pos.x, this.pos.y, aim + i * 0.12, 13, { owner: 'enemy', damage: 2, radius: 4, color: '#ff0' });
                    b.owner = this;
            ...
            if (this.phaseTick % 50 === 0) {
                ...
                for (let i = 0; i < 8; i++) {
                    ...
                    const b = new Bullet(this.pos.x, this.pos.y, a, 15, { owner: 'enemy', damage: 1, radius: 3, color: '#fc0' });
                    b.owner = this;
                    GameContext.bullets.push(b);
                }
            ...
            if (this.phaseTick % 30 === 0) {
                ...
                for (let i = 0; i < 20; i++) {
                    ...
                    const b = new Bullet(this.pos.x, this.pos.y, a, 6, { owner: 'enemy', damage: 1, radius: 4, color: '#ff0' });
                    b.owner = this;
                    GameContext.bullets.push(b);
                }
                playSound('shotgun');
            ...
            if (this.phaseTick % 8 === 0) {
                ...
                const b = new Bullet(this.pos.x, this.pos.y, aim + (Math.random() - 0.5) * 0.2, 14, { owner: 'enemy', damage: 2, radius: 3, color: '#f80' });
                b.owner = this;
                GameContext.bullets.push(b);
                playSound('rapid_shoot');
            }
    ...
    releaseRevengeBurst() {
        ...
        for (let i = 0; i < 24; i++) {
            ...
            const b = new Bullet(this.pos.x, this.pos.y, a, 10, { owner: 'enemy', damage: damagePerProjectile, radius: 4, color: '#f00' });
            b.owner = this;
            b.life = 120;
            GameContext.bullets.push(b);
        }
