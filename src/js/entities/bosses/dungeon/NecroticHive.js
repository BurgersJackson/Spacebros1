        ...
        if (this.phaseName === 'SWARM_SUMMON') {
            ...
            if (this.phaseTick % 60 === 0) {
                ...
                for (let i = 0; i < 16; i++) {
                    ...
                    const b = new Bullet(this.pos.x, this.pos.y, a, 7, { owner: 'enemy', damage: 1, radius: 4, color: '#f6f' });
                    b.owner = this;
            ...
            if (this.phaseTick % 45 === 0) {
                ...
                for (let i = 0; i < 12; i++) {
                    ...
                    const b = new Bullet(this.pos.x, this.pos.y, a, 9, { owner: 'enemy', damage: 1, radius: 4, color: '#f80' });
                    b.owner = this;
                    GameContext.bullets.push(b);
                }
                playSound('shotgun');
            ...
            if (this.phaseTick % 60 === 0) {
                // Napalm zone
                if (_spawnNapalmZone) {
                    _spawnNapalmZone(this.pos.x + (Math.random() - 0.5) * 200, this.pos.y + (Math.random() - 0.5) * 200, 3, 80);
                }
            }
            ...
            if (this.phaseTick % 8 === 0) {
                // Rapid triple spread
                for (let i = -1; i <= 1; i++) {
                    const b = new Bullet(this.pos.x, this.pos.y, aim + i * 0.15, 12, { owner: 'enemy', damage: 1, radius: 3, color: '#f44' });
                    b.owner = this;
                    GameContext.bullets.push(b);
                }
            ...
            if (this.phaseTick % 50 === 0) {
                ...
                for (let i = 0; i < 16; i++) {
                    ...
                    const b = new Bullet(this.pos.x, this.pos.y, a, 8, { owner: 'enemy', damage: 1, radius: 4, color: '#f80' });
                    b.owner = this;
                    GameContext.bullets.push(b);
                }
                playSound('shotgun');
            ...
            if (this.phaseTick % 5 === 0) {
                ...
                const b = new Bullet(this.pos.x, this.pos.y, a, 14, { owner: 'enemy', damage: 1, radius: 3, color: '#f6f' });
                b.owner = this;
                GameContext.bullets.push(b);
            }
