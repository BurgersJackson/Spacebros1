...
2. Random upgrade: Selects random upgrade from UPGRADE_DATA categories
   ...
   - Specials: xp_magnet, area_nuke, invincibility, slow_field, time_dilation, momentum
...
if (GameContext.sectorIndex === 1 && !warpActive &&
    !GameContext.dungeon1Active && !GameContext.isaacDungeonActive &&
    !GameContext.bossActive && !GameContext.sectorTransitionActive &&
    !GameContext.isaacDungeonCompletedOnce && !GameContext.caveMode &&
...
```javascript
if (!warpActive && !GameContext.dungeon1Active && !GameContext.isaacDungeonActive &&
    !GameContext.bossActive && !GameContext.sectorTransitionActive &&
    GameContext.warpCompletedOnce && !GameContext.isaacDungeonCompletedOnce &&
    !GameContext.caveMode && !GameContext.spaceStation &&
